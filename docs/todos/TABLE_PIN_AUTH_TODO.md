...
- [ ] (P0) Modificar `useSocketContext` para carga condicional según rol
...
- [ ] (P0) Crear función generadora de QR code
  - Archivo(s): `client/src/utils/qr.ts` (nuevo)
  - Criterio: Dado un tableId, genera canvas/image con código QR escaneable
  - Estado: TODO

- [ ] (P0) Modificar `DashboardStatusChip` para mostrar PIN+QR para Owner
...
- [ ] (P1) Guardar PIN en localStorage tras validación exitosa
  - Archivo(s): `client/src/pages/DashboardPage/DashboardPage.tsx`
...
- [ ] (P1) Test: Owner ve PIN+QR en dashboard
  - Archivo(s): tests/
  - Criterio: Verificar renderizado de PIN y QR para isOwner=true
  - Estado: TODO

- [ ] (P1) Test: Click en mesa abre modal
  - Archivo(s): tests/
  - Criterio: onTableClick abre PinModal
  - Estado: TODO

- [ ] (P1) Test: PIN correcto navega, PIN incorrecto no
  - Archivo(s): tests/
...
- [ ] (P2) Verificar que no hay PIN en logs
