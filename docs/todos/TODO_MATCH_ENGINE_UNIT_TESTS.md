...
### Fase 1 - P0: Setup
- [ ] (P0) Verificar configuración de Jest (ts-jest) y crear estructura de tests
...
- [ ] (P0) Mockear logger para silenciar output en tests
...
- [ ] (P0) Tests de estado inicial y config por defecto
...
- [ ] (P0) Tests de configure con config custom
...
- [ ] (P0) Tests de match win — bestOf=3 y bestOf=5
...
- [ ] (P0) Tests de undoLast — undo funcional y canUndo
...
- [ ] (P0) Tests de subtractPoint — resta correcta
...
- [ ] (P1) Tests de checkSideSwap — swap en sets regulares y decisivo
...
- [ ] (P1) Tests de handicap — score inicial con puntos extra
  - Archivo(s): `server/tests/matchEngine.spec.ts` (describe: 'handicap')
  - Criterio: handicapA=3 → score.a inicia en 3
  - Estado: TODO

- [ ] (P1) Tests de edge cases — undo sin history, subtract en 0, bestOf=5
