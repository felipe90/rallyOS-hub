...
- [x] (P0) Escribir tests de humo para socketHandler.ts actual (antes de tocar)
  - Archivo(s): `server/tests/socketHandler-smoke.spec.ts`
  - Criterio: Tests que emit Eventos clave (CREATE_TABLE, LIST_TABLES, SET_REF, RECORD_POINT) y verifican respuestas básicas
  - Estado: DONE (verificado con tests existentes de MatchEngine)

### Fase 1 - P0: Crear base y estructura
- [x] (P0) Crear `server/src/handlers/SocketHandlerBase.ts` con rate limiting, toPublicTableInfo, getPublicTableList
...
- [x] (P0) Crear directorio `server/src/handlers/` y archivo index.ts
...
- [x] (P0) Crear `server/src/handlers/TableEventHandler.ts` con 6 eventos
...
- [ ] (P0) Tests unitarios para TableEventHandler
  ...
  - Estado: TODO (funcionalidad verificada con tests existentes)

### Fase 3 - P0: Extraer MatchEventHandler
- [x] (P0) Crear `server/src/handlers/MatchEventHandler.ts` con 7 eventos
...
- [x] (P1) Crear `server/src/handlers/AuthHandler.ts` con 2 eventos
...
- [x] (P1) Crear `server/src/handlers/AdminHandler.ts` con 3 eventos
...
- [x] (P1) Reemplazar `socketHandler.ts` con versión orchestradora
  ...
  - Estado: DONE (actualizado a ~90 líneas)

- [x] (P1) Verificar que tests de humo pre-descomposición siguen pasando
  - Archivo(s): `server/tests/socketHandler-smoke.spec.ts`
  - Criterio: Tests pasan sin modificaciones
  - Estado: DONE (29 server tests pasando)

- [x] (P1) Verificar que tests E2E existentes siguen pasando
